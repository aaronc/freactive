...
freactive.cljs_perf.bench = (function bench(f){var start__12390__auto__ = (new Date()).getTime();var ret__12391__auto__ = (function (){var n__12365__auto__ = (100000);var i = (0);while(true){
if((i < n__12365__auto__))
{f.call(null);
{
var G__13229 = (i + (1));
i = G__13229;
...
})();cljs.core.prn.call(null,("Elapsed time: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(((new Date()).getTime() - start__12390__auto__))+" msecs"));
return ret__12391__auto__;
});
freactive.cljs_perf.ITest1 = (function (){var obj13231 = {};return obj13231;
})();
freactive.cljs_perf._do_something = (function _do_something(this$){if((function (){var and__11483__auto__ = this$;if(and__11483__auto__)
...
{var x__12132__auto__ = (((this$ == null))?null:this$);return (function (){var or__11495__auto__ = (freactive.cljs_perf._do_something[goog.typeOf(x__12132__auto__)]);if(or__11495__auto__)
{return or__11495__auto__;
} else
{var or__11495__auto____$1 = (freactive.cljs_perf._do_something["_"]);if(or__11495__auto____$1)
...
freactive.cljs_perf.test1 = (function (){var method_table__12375__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);var prefer_table__12376__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);var method_cache__12377__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);var cached_hierarchy__12378__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);var hierarchy__12379__auto__ = cljs.core.get.call(null,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),cljs.core.get_global_hierarchy.call(null));return (new cljs.core.MultiFn("test1",cljs.core.type,new cljs.core.Keyword(null,"default","default",-1987822328),hierarchy__12379__auto__,method_table__12375__auto__,prefer_table__12376__auto__,method_cache__12377__auto__,cached_hierarchy__12378__auto__));
})();
...
freactive.cljs_perf.bench.call(null,(function (){var G__13232 = "abc";if(G__13232)
...
{return G__13232.freactive$cljs_perf$ITest1$;
}
})()))
{return true;
} else
{if((!G__13232.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,freactive.cljs_perf.ITest1,G__13232);
} else
{return false;
}
}
...
freactive.cljs_perf.IElementSpec = (function (){var obj13234 = {};return obj13234;
})();
freactive.cljs_perf._get_virtual_dom = (function _get_virtual_dom(x){if((function (){var and__11483__auto__ = x;if(and__11483__auto__)
...
{var x__12132__auto__ = (((x == null))?null:x);return (function (){var or__11495__auto__ = (freactive.cljs_perf._get_virtual_dom[goog.typeOf(x__12132__auto__)]);if(or__11495__auto__)
{return or__11495__auto__;
} else
{var or__11495__auto____$1 = (freactive.cljs_perf._get_virtual_dom["_"]);if(or__11495__auto____$1)
{return or__11495__auto____$1;
} else
...
freactive.cljs_perf.ElementSpec.prototype.cljs$core$ILookup$_lookup$arity$2 = (function (this__12091__auto__,k__12092__auto__){var self__ = this;
var this__12091__auto____$1 = this;return cljs.core._lookup.call(null,this__12091__auto____$1,k__12092__auto__,null);
});
freactive.cljs_perf.ElementSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__12093__auto__,k13236,else__12094__auto__){var self__ = this;
var this__12093__auto____$1 = this;var G__13238 = (((k13236 instanceof cljs.core.Keyword))?k13236.fqn:null);switch (G__13238) {
case "spec":
return self__.spec;

break;
default:
return cljs.core.get.call(null,self__.__extmap,k13236,else__12094__auto__);

}
});
freactive.cljs_perf.ElementSpec.prototype.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = (function (this__12105__auto__,writer__12106__auto__,opts__12107__auto__){var self__ = this;
...
;return cljs.core.pr_sequential_writer.call(null,writer__12106__auto__,pr_pair__12108__auto__,"#freactive.cljs-perf.ElementSpec{",", ","}",opts__12107__auto__,cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"spec","spec",347520401),self__.spec],null))], null),self__.__extmap));
});
...
freactive.cljs_perf.ElementSpec.prototype.cljs$core$IMeta$_meta$arity$1 = (function (this__12089__auto__){var self__ = this;
var this__12089__auto____$1 = this;return self__.__meta;
});
freactive.cljs_perf.ElementSpec.prototype.cljs$core$ICloneable$_clone$arity$1 = (function (this__12085__auto__){var self__ = this;
var this__12085__auto____$1 = this;return (new freactive.cljs_perf.ElementSpec(self__.spec,self__.__meta,self__.__extmap,self__.__hash));
});
freactive.cljs_perf.ElementSpec.prototype.cljs$core$ICounted$_count$arity$1 = (function (this__12095__auto__){var self__ = this;
var this__12095__auto____$1 = this;return (1 + cljs.core.count.call(null,self__.__extmap));
});
freactive.cljs_perf.ElementSpec.prototype.cljs$core$IHash$_hash$arity$1 = (function (this__12086__auto__){var self__ = this;
...
freactive.cljs_perf.ElementSpec.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this__12087__auto__,other__12088__auto__){var self__ = this;
...
freactive.cljs_perf.ElementSpec.prototype.cljs$core$IMap$_dissoc$arity$2 = (function (this__12100__auto__,k__12101__auto__){var self__ = this;
...
{return (new freactive.cljs_perf.ElementSpec(self__.spec,self__.__meta,cljs.core.not_empty.call(null,cljs.core.dissoc.call(null,self__.__extmap,k__12101__auto__)),null));
}
});
freactive.cljs_perf.ElementSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__12098__auto__,k__12099__auto__,G__13235){var self__ = this;
var this__12098__auto____$1 = this;var pred__13239 = cljs.core.keyword_identical_QMARK_;var expr__13240 = k__12099__auto__;if(cljs.core.truth_(pred__13239.call(null,new cljs.core.Keyword(null,"spec","spec",347520401),expr__13240)))
{return (new freactive.cljs_perf.ElementSpec(G__13235,self__.__meta,self__.__extmap,null));
} else
{return (new freactive.cljs_perf.ElementSpec(self__.spec,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__12099__auto__,G__13235),null));
}
});
freactive.cljs_perf.ElementSpec.prototype.cljs$core$ISeqable$_seq$arity$1 = (function (this__12103__auto__){var self__ = this;
...
freactive.cljs_perf.ElementSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__12090__auto__,G__13235){var self__ = this;
var this__12090__auto____$1 = this;return (new freactive.cljs_perf.ElementSpec(self__.spec,G__13235,self__.__extmap,self__.__hash));
});
freactive.cljs_perf.ElementSpec.prototype.cljs$core$ICollection$_conj$arity$2 = (function (this__12096__auto__,entry__12097__auto__){var self__ = this;
...
freactive.cljs_perf.ElementSpec.cljs$lang$ctorPrSeq = (function (this__12125__auto__){return cljs.core._conj.call(null,cljs.core.List.EMPTY,"freactive.cljs-perf/ElementSpec");
});
freactive.cljs_perf.ElementSpec.cljs$lang$ctorPrWriter = (function (this__12125__auto__,writer__12126__auto__){return cljs.core._write.call(null,writer__12126__auto__,"freactive.cljs-perf/ElementSpec");
});
freactive.cljs_perf.__GT_ElementSpec = (function __GT_ElementSpec(spec){return (new freactive.cljs_perf.ElementSpec(spec));
});
freactive.cljs_perf.map__GT_ElementSpec = (function map__GT_ElementSpec(G__13237){return (new freactive.cljs_perf.ElementSpec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(G__13237),null,cljs.core.dissoc.call(null,G__13237,new cljs.core.Keyword(null,"spec","spec",347520401))));
});
...
freactive.cljs_perf.IHasDOMNode = (function (){var obj13244 = {};return obj13244;
})();
freactive.cljs_perf._get_dom_node = (function _get_dom_node(x){if((function (){var and__11483__auto__ = x;if(and__11483__auto__)
...
{var x__12132__auto__ = (((x == null))?null:x);return (function (){var or__11495__auto__ = (freactive.cljs_perf._get_dom_node[goog.typeOf(x__12132__auto__)]);if(or__11495__auto__)
{return or__11495__auto__;
} else
{var or__11495__auto____$1 = (freactive.cljs_perf._get_dom_node["_"]);if(or__11495__auto____$1)
{return or__11495__auto____$1;
} else
...
freactive.cljs_perf.IRemove = (function (){var obj13246 = {};return obj13246;
})();
freactive.cljs_perf._remove_BANG_ = (function _remove_BANG_(x){if((function (){var and__11483__auto__ = x;if(and__11483__auto__)
...
{var x__12132__auto__ = (((x == null))?null:x);return (function (){var or__11495__auto__ = (freactive.cljs_perf._remove_BANG_[goog.typeOf(x__12132__auto__)]);if(or__11495__auto__)
{return or__11495__auto__;
} else
{var or__11495__auto____$1 = (freactive.cljs_perf._remove_BANG_["_"]);if(or__11495__auto____$1)
{return or__11495__auto____$1;
} else
